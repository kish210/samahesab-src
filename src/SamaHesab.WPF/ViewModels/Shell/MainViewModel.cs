...
public partial class MainViewModel : BaseViewModel
{
        ...
        : base(dialogService, navigationService)
    {
        ...
        _pages = new Dictionary<string, (string, Func<IServiceProvider, BaseViewModel>)>
        {
            ...
            // «مدیریت ماژول‌ها» = Module Managerِ یکپارچه (فعال/غیرفعال + نصب/به‌روزرسانی/حذف از بازار).
            ["Modules"]         = ("مدیریت ماژول‌ها",     sp => sp.GetRequiredService<ViewModels.Settings.ModuleMarketplaceViewModel>()),
