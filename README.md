# سامانهٔ جامع «سما حساب» — نسخهٔ ۲.۵.۰
...
## ⬇️ دانلود (نسخهٔ ۲.۵.۰)

**نصابِ کاملِ خودکفا** (شاملِ .NET runtime — نیازی به پیش‌نیاز ندارد):

### 👉 [دانلودِ `SamaHesab_Setup_v2.5.0.exe`](https://github.com/kish210/SamaHesab/releases/download/v2.5.0/SamaHesab_Setup_v2.5.0.exe)
