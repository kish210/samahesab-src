...
;  Self-contained (.NET همراه سرور است). پیش‌نیاز فقط: Microsoft SQL Server (Express یا بالاتر).
; =============================================================================

#define AppName       "سما حساب — وب"
#define AppVersion    "2.9.11"
...
[Setup]
AppId={{8F2A1C40-7B3E-4D5A-9C11-SAMAHESABWEB01}
AppName={#AppName}
...
[Tasks]
Name: "desktopicon"; Description: "ایجاد میانبر روی دسکتاپ (باز کردنِ کلاینتِ وب در مرورگر)"; Flags: unchecked
...
[Files]
; سرور Web API + کلاینتِ وبِ React (خودکفا — dist\api\wwwroot\web از build)
...
Name: "{group}\کلاینت وب سما حساب (مرورگر)"; Filename: "{#WebClientUrl}"
...
; تمیز متوقفش کند، سپس کلاینتِ وب را در مرورگرِ پیش‌فرض باز می‌کند.
...
Filename: "{#WebClientUrl}"; Description: "بازکردنِ کلاینتِ وب در مرورگر"; \
