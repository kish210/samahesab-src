...
3. اسکریپت‌های پوشهٔ `database/` را به‌ترتیبِ شماره (۰۱ تا انتها) در SQL Server اجرا کنید تا جدول‌ها و دادهٔ اولیه ساخته شوند.
...
dotnet test  tests/SamaHesab.Tests            # ~۲۱۸ تست
