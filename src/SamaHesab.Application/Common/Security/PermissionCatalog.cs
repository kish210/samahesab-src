...
public static class PermissionCatalog
{
    ...
    public static readonly IReadOnlyList<PermissionDef> All = new List<PermissionDef>
    {
        ...
        // رستوران — تفکیکِ نقشِ گارسون/صندوق/آشپزخانه/مدیر
        new("Restaurant.Operate", "رستوران", "گارسون — ثبت/ویرایشِ سفارشِ میز و ارسال به آشپزخانه"),
        new("Restaurant.Cashier", "رستوران", "صندوق — تسویهٔ صورت‌حسابِ میز"),
        new("Restaurant.Kitchen", "رستوران", "آشپزخانه — مشاهده و تکمیلِ تیکتِ آشپزخانه (KOT)"),
        new("Restaurant.Manage",  "رستوران", "مدیر — تعریفِ سالن/میز و تنظیماتِ رستوران"),
        // گردشگری — تفکیکِ نقشِ مدیر/اپراتور از فروشنده
        new("Tourism.View",   "گردشگری", "مشاهدهٔ محصولات/گزارش‌های گردشگری"),
        new("Tourism.Manage", "گردشگری", "تعریف محصول، قیمت‌گذاری، نرخِ کمیسیونِ فروشندگان، ودیعهٔ تأمین‌کننده"),
        new("Tourism.Sell",   "گردشگری", "ثبتِ فروشِ گردشگری (فروشنده) — دیدنِ قیمت/ظرفیت و فروش"),
        // امنیت/تنظیمات
